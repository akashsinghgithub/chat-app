  ...
  return (
    <>
      <Box d="flex" justifyContent="space-between" alignItems="center" bg="white" w="100%" p="5px 10px 5px 10px" borderWidth="5px">
        ...
        <Text fontSize="2xl" fontFamily="Work sans">Let's chat</Text>
        <div>
          <Menu>
            <MenuButton p={1}>
          ...
          <Menu>
            ...
            <MenuList>
              {/* Pass selectedUser as a prop to ProfileModal */}
              <ProfileModal user={selectedUser}>
                <MenuItem onClick={() => handleUserClick(user)}>View Profile</MenuItem>
              </ProfileModal>
              <MenuDivider />
